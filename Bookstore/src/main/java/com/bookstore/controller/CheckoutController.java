...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") Long cartId,
		...
		List<String> provinceList = CanadaConstants.listOfCanadaProvinceCodes;
	...
	public String setPaymentMethod(@RequestParam("userPaymentId") Long paymentId, Model model, Principal principal) {

		User user = userService.findByUsername(principal.getName());
		UserPayment userPayment = userPaymentService.findById(paymentId);
